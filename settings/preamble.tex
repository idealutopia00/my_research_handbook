...
\usepackage[backend=biber,
            style=gb7714-2015,  % <--- 【核心修改】改成中国国标样式
            % style=ieee,
            sorting=none]{biblatex}
\addbibresource{bib/ai_foundations.bib} % AI foundations references
\addbibresource{bib/smart_mining.bib} % Smart mining references
\addbibresource{bib/emerging_technologies.bib} % Emerging AI technologies references
